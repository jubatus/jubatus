...
class graph {
 public:
  ...
  bool update_node(std::string name, std::string node_id,
  ...
  double get_centrality(std::string name, std::string node_id,
    ...
    return c_.call("get_centrality", name, node_id, centrality_type, query)
        .get<double>();
  }
  ...
  std::vector<std::string> get_shortest_path(std::string name,
    ...
    return c_.call("get_shortest_path", name, query)
