// This file is auto-generated from stat.idl(0.6.4-33-gcc8d7ca) with jenerator version 0.6.4-145-g9341cb5/feature/save_returns_id_and_path
// *** DO NOT EDIT ***
 ...
 public:
  explicit stat_impl(const jubatus::server::framework::server_argv& a):
    ...
    rpc_server::add<std::map<std::string, std::string>(std::string,
        std::string)>("save", jubatus::util::lang::bind(&stat_impl::save, this,
        jubatus::util::lang::_2));
