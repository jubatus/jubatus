...
#ifndef JUBATUS_SERVER_SERVER_TEST_UTIL_HPP_
#define JUBATUS_SERVER_SERVER_TEST_UTIL_HPP_
...
pid_t fork_process(
  ...
  pid_t child;
  cmd += "/jubatus/server/server/juba";
  cmd += name;
  child = fork();
...
#endif  // JUBATUS_SERVER_SERVER_TEST_UTIL_HPP_
