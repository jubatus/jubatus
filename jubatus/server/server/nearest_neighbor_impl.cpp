// This file is auto-generated from nearest_neighbor.idl(0.4.5-347-g86989a6) with jenerator version 0.5.2-17-g8a5dca4/feature/set_get_labels
// *** DO NOT EDIT ***
 ...
 public:
  explicit nearest_neighbor_impl(
    ...
    rpc_server::add<std::vector<std::pair<std::string, float> >(std::string,
        ...
        jubatus::util::lang::bind(&nearest_neighbor_impl::similar_row_from_data,
        this, jubatus::util::lang::_2, jubatus::util::lang::_3));
