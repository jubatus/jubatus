// This file is auto-generated from nearest_neighbor.idl(0.6.4-33-gf65b203) with jenerator version 0.6.4-146-g79178f8/feature/save_returns_id_and_path
// *** DO NOT EDIT ***
 ...
 public:
  explicit nearest_neighbor_impl(
    ...
    rpc_server::add<std::map<std::string, std::string>(std::string,
        std::string)>("save", jubatus::util::lang::bind(
