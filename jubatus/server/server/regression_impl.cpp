// This file is auto-generated from regression.idl(0.6.4-33-gcc8d7ca) with jenerator version 0.6.4-145-g9341cb5/feature/save_returns_id_and_path
// *** DO NOT EDIT ***
 ...
 public:
  explicit regression_impl(const jubatus::server::framework::server_argv& a):
    ...
    rpc_server::add<std::map<std::string, std::string>(std::string,
        std::string)>("save", jubatus::util::lang::bind(&regression_impl::save,
