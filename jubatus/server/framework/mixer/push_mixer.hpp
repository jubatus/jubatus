...
public:
  ...
  create(const pfi::lang::shared_ptr<jubatus::server::common::lock_service>& zk,
  ...
  virtual pfi::lang::shared_ptr<jubatus::server::common::try_lockable> create_lock() = 0;
...
public:
  ...
  void set_mixable_holder(pfi::lang::shared_ptr<jubatus::core::framework::mixable_holder> holder);
  ...
  void get_status(jubatus::server::framework::server_base::status_t& status) const;
