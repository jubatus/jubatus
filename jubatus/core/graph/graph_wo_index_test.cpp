...
TEST(graph_wo_index, none) {
  ...
  EXPECT_THROW(g.update_node(7, property()), jubatus::core::common::exception::runtime_error);
  EXPECT_THROW(g.remove_global_node(7), jubatus::core::common::exception::runtime_error);
  EXPECT_THROW(g.update_edge(8, property()), jubatus::core::common::exception::runtime_error);
  EXPECT_THROW(g.remove_edge(8), jubatus::core::common::exception::runtime_error);
  ...
  EXPECT_THROW(g.create_edge(10002, 4, 5), jubatus::core::common::exception::runtime_error);
  EXPECT_THROW(g.create_edge(10002, 999, 5), jubatus::core::common::exception::runtime_error);
  {
    map<string, string> status;
    g.get_status(status);
    ASSERT_EQ("2", status["local_node_num"]);
  ...
  EXPECT_THROW(g.remove_node(5), jubatus::core::common::exception::runtime_error);
  EXPECT_THROW(g.remove_node(999), jubatus::core::common::exception::runtime_error);
  EXPECT_THROW(g.remove_edge(5), jubatus::core::common::exception::runtime_error);
  EXPECT_THROW(g.remove_node(777),
               jubatus::core::common::exception::runtime_error);  // edge is associated
