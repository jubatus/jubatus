...
int main(int args, char** argv){
  ...
  k.register_cht<1, int, edge_info >("create_edge", pfi::lang::function<int(int,int)>(&all_and)); //update
  k.register_cht<2, int, edge_id_t, edge_info >("update_edge", pfi::lang::function<int(int,int)>(&all_and)); //update
  k.register_cht<2, int, edge_id_t >("remove_edge", pfi::lang::function<int(int,int)>(&all_and)); //update
  ...
  k.register_cht<2, edge_info, edge_id_t >("get_edge", pfi::lang::function<edge_info(edge_info,edge_info)>(&pass<edge_info >)); //analysis
