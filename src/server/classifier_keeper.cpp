...
int main(int args, char** argv){
  try{
    keeper2 k(keeper_argv(args,argv,"classifier"));
    ...
    k.register_async_random<int, std::vector<std::pair<std::string,datum > > >("train"); //pass update
    k.register_async_random<std::vector<std::vector<estimate_result > >, std::vector<datum > >("classify"); //pass analysis
