...
template<class Impl>
class anomaly : public jubatus::common::mprpc::rpc_server {
 public:
  anomaly(double timeout_sec)
    ...
    rpc_server::add<std::pair<std::string, float>(std::string, datum)>(
        "add",
        pfi::lang::bind(&Impl::add, static_cast<Impl*>(this), pfi::lang::_1,
                        pfi::lang::_2));
    rpc_server::add<float(std::string, std::string, datum)>(
        "update",
        pfi::lang::bind(&Impl::update, static_cast<Impl*>(this), pfi::lang::_1,
    ...
    rpc_server::add<float(std::string, datum)>(
        "calc_score",
        pfi::lang::bind(&Impl::calc_score, static_cast<Impl*>(this),
                        pfi::lang::_1, pfi::lang::_2));
