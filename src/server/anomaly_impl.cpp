...
class anomaly_impl_ : public anomaly<anomaly_impl_> {
 public:
  ...
  ;
  common::cshared_ptr<anomaly_serv> get_p() {
    return p_->server();
  }
  ;
 private:
...
int main(int args, char** argv) {
  return jubatus::framework::run_server<jubatus::server::anomaly_impl_>(
      args, argv, "anomaly");
}
