...
int main(int args, char** argv){
  ...
  k.register_cht<datum >("complete_row_from_id", pfi::lang::function<datum(datum,datum)>(&random<datum >)); //analysis
  k.register_random<datum, datum >("complete_row_from_data"); //pass analysis
  k.register_cht<similar_result, unsigned int >("similar_row_from_id", pfi::lang::function<similar_result(similar_result,similar_result)>(&random<similar_result >)); //analysis
  ...
  k.register_random<float, datum, datum >("similarity"); //random analysis
  k.register_random<float, datum >("l2norm"); //random analysis
