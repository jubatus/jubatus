  ...
  stat(double timeout_sec)
    ...
    rpc_server::add<std::string(std::string)>(
        ...
        pfi::lang::bind(&Impl::get_config, static_cast<Impl*>(this),
                        pfi::lang::_1));
    rpc_server::add<bool(std::string, std::string, double)>(
        "push",
        pfi::lang::bind(&Impl::push, static_cast<Impl*>(this), pfi::lang::_1,
                        pfi::lang::_2, pfi::lang::_3));
    rpc_server::add<double(std::string, std::string)>(
        "sum",
        pfi::lang::bind(&Impl::sum, static_cast<Impl*>(this), pfi::lang::_1,
                        pfi::lang::_2));
    rpc_server::add<double(std::string, std::string)>(
        "stddev",
        pfi::lang::bind(&Impl::stddev, static_cast<Impl*>(this), pfi::lang::_1,
                        pfi::lang::_2));
    rpc_server::add<double(std::string, std::string)>(
        "max",
        pfi::lang::bind(&Impl::max, static_cast<Impl*>(this), pfi::lang::_1,
                        pfi::lang::_2));
    rpc_server::add<double(std::string, std::string)>(
        "min",
        pfi::lang::bind(&Impl::min, static_cast<Impl*>(this), pfi::lang::_1,
                        pfi::lang::_2));
    rpc_server::add<double(std::string, std::string)>(
        "entropy",
        pfi::lang::bind(&Impl::entropy, static_cast<Impl*>(this), pfi::lang::_1,
                        pfi::lang::_2));
    rpc_server::add<double(std::string, std::string, int32_t, double)>(
        "moment",
        pfi::lang::bind(&Impl::moment, static_cast<Impl*>(this), pfi::lang::_1,
