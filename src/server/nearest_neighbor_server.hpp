...
#ifndef JUBATUS_SERVER_NEAREST_NEIGHBOR_SERVER_HPP_
#define JUBATUS_SERVER_NEAREST_NEIGHBOR_SERVER_HPP_
...
template <class Impl>
class nearest_neighbor : public jubatus::common::mprpc::rpc_server {
 public:
...
#endif  // JUBATUS_SERVER_NEAREST_NEIGHBOR_SERVER_HPP_
