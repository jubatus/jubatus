...
int main(int args, char** argv){
  ...
  k.register_cht<double >("sum", pfi::lang::function<double(double,double)>(&pass<double >)); //analysis
  k.register_cht<double >("stddev", pfi::lang::function<double(double,double)>(&pass<double >)); //analysis
  k.register_cht<double >("max", pfi::lang::function<double(double,double)>(&pass<double >)); //analysis
  k.register_cht<double >("min", pfi::lang::function<double(double,double)>(&pass<double >)); //analysis
  k.register_cht<double >("entropy", pfi::lang::function<double(double,double)>(&pass<double >)); //analysis
  k.register_cht<double, int, double >("moment", pfi::lang::function<double(double,double)>(&pass<double >)); //analysis
