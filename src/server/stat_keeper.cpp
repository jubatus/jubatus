...
int main(int args, char** argv){
  try{
    keeper2 k(keeper_argv(args,argv,"stat"));
    ...
    k.register_async_cht<1, double >("max", pfi::lang::function<double(double,double)>(&pass<double >)); //analysis
    k.register_async_cht<1, double >("min", pfi::lang::function<double(double,double)>(&pass<double >)); //analysis
    k.register_async_cht<1, double >("entropy", pfi::lang::function<double(double,double)>(&pass<double >)); //analysis
    k.register_async_cht<1, double, int, double >("moment", pfi::lang::function<double(double,double)>(&pass<double >)); //analysis
