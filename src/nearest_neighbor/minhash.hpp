...
#ifndef JUBATUS_NEAREST_NEIGHBOR_MINHASH_HPP_
#define JUBATUS_NEAREST_NEIGHBOR_MINHASH_HPP_
...
class minhash : public bit_vector_nearest_neighbor_base {
 public:
  ...
  virtual std::string type() const { return "minhash"; }
...
#endif  // JUBATUS_NEAREST_NEIGHBOR_MINHASH_HPP_
