...
public:
  ...
  virtual float calc_anomaly_score(const sfv_t& query, size_t neighbor_num) const = 0; //return anomaly score of query
  ...
  float calc_anomaly_score(const std::string& id, size_t neighbor_num) const;
