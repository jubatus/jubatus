...
#ifndef JUBATUS_CORE_SRC_FV_CONVERTER_EXCEPT_MATCH_HPP_
#define JUBATUS_CORE_SRC_FV_CONVERTER_EXCEPT_MATCH_HPP_
...
#endif  // JUBATUS_CORE_SRC_FV_CONVERTER_EXCEPT_MATCH_HPP_
