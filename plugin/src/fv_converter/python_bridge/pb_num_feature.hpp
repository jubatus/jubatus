...
#ifndef JUBATUS_PLUGIN_FV_CONVERTER_PYTHON_BRIDGE_PB_NUM_FEATURE_HPP_
#define JUBATUS_PLUGIN_FV_CONVERTER_PYTHON_BRIDGE_PB_NUM_FEATURE_HPP_
 ...
 *     [number].
 */
class pb_num_feature
    : public jubatus::core::fv_converter::num_feature {
 public:
  explicit pb_num_feature(PyObject* ins)
      : name_("extract"),
        ins_(ins),
...
#endif  // JUBATUS_PLUGIN_FV_CONVERTER_PYTHON_BRIDGE_PB_NUM_FEATURE_HPP_
